...
export function createOtpEmailTemplate(otp) {
  ...
  <body style="font-family: Arial, sans-serif; color: #111; background-color: #f6f6f6; padding: 20px;">
    <div style="max-width: 520px; margin: 0 auto; background: #ffffff; border-radius: 12px; padding: 24px; border: 1px solid #e5e5e5;">
      <h2 style="margin: 0 0 12px 0;">Your OTP Code</h2>
      <p style="margin: 0 0 16px 0;">Use this OTP to reset your password. It expires in 5 minutes.</p>
      <div style="font-size: 28px; font-weight: bold; letter-spacing: 6px; background: #111; color: #fff; padding: 12px 16px; border-radius: 8px; display: inline-block;">
        ${otp}
      </div>
